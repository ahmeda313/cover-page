export default function Results({result}){
    ...
    if(result==="loading"){
        ...
        <div className="text-center mt-3">
            <div role="status">
                <svg aria-hidden="true" className="inline w-12 h-12 text-gray-200 animate-spin dark:text-gray-600 fill-gray-100" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
